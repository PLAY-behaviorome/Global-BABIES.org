...
flowchart TD
  ...
  subgraph Collection ["`**Collection**`"]
    Collect("Data collection") --> Upload{{"Curate & upload to Databrary"}}
    Upload --> QA[/"BABIES team QA"\] --"`**PASS**`"--> Share[("Share on BABIES Databrary volume")]
    QA --"`**FAIL**`"--> Retrain[/"Retrain with BABIES team"/]
  ...
  Share ==> Proc
  subgraph Proc["`**Coding**`"]
    Script("Transcription & Annotation") --> QA2[\"BABIES team QA"/]
    QA2 --> Release[("Release on Databrary")]
